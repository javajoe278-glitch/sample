...
export const dropdownTriggerShellClassName = cn(
  ...
  "group w-full gap-2 px-3 text-[var(--oh-muted)] hover:text-contrast",
);
...
export const dropdownMenuRowIconClassName = cn(
  "shrink-0 text-[var(--oh-muted)] group-hover:text-contrast group-focus-visible:text-contrast",
  dropdownInstantColorClassName,
);
...
export const dropdownFilterTriggerClassName = cn(
  ...
  "border-[var(--oh-border)] bg-base-secondary text-contrast",
