          ...
          >
            {active.backend.kind === "cloud" ? (
              <a
                ...
                className={cn(
                  "inline-flex items-center justify-center shrink-0 w-9 h-9 rounded-md text-[var(--oh-muted)] hover:text-contrast hover:bg-[var(--oh-surface-raised)] cursor-pointer",
