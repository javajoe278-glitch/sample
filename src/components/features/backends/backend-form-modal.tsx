  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected
          ? "bg-[var(--oh-surface-raised)] text-contrast after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 after:bg-primary"
          : "text-[var(--oh-muted)] hover:bg-[var(--oh-surface-raised)] hover:text-contrast",
      )}
    >
      <span
