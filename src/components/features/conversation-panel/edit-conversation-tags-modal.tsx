        ...
        >
              ...
              {rows.map((row) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="shrink-0 text-[var(--oh-muted)] hover:text-contrast"
                  >
          ...
          <div className="flex w-full items-center gap-2">
            <input
              ...
              className="w-28 shrink-0 rounded-md border border-[var(--oh-border)] bg-base-secondary px-2 py-1 text-xs text-contrast placeholder:text-[var(--oh-muted)]"
            />
            <input
              type="text"
              value={newValue}
              ...
              onKeyDown={handleInputKeyDown}
              className="min-w-0 flex-1 rounded-md border border-[var(--oh-border)] bg-base-secondary px-2 py-1 text-xs text-contrast placeholder:text-[var(--oh-muted)]"
            />
            <BrandButton
              type="button"
              variant="secondary"
